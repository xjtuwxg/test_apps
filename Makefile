...
vm:
	@echo " [COPY BIN TO VM] $^"
	sshpass -p "popcorn" scp $(X86_64_ALIGNED) popcorn@vm1:
	sshpass -p "popcorn" scp $(ARM64_ALIGNED) popcorn@vm1:
	sshpass -p "popcorn" scp $(X86_64_ALIGNED) popcorn@vm2:
	sshpass -p "popcorn" scp $(ARM64_ALIGNED) popcorn@vm2:
ir: $(IR)
